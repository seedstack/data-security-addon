...
public class MyUnsecuredPojo {
    ...
    @MyRestriction(expression = "${1 == 2}", todo = MyRestriction.Todo.Initial)
    private String name;

    @MyRestriction(expression = "${ hasRole('jedi') && hasPermission('academy:learn')  }", todo = MyRestriction.Todo.Hide)
